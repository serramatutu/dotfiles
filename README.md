...
- **topics/topic/install.py**: a python3 module which contains at least an ```install()``` function. This function may prompt the user for custom input, run shell scripts or do virtually anything else.
